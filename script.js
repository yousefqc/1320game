...
const questionsData = {
    'kuwait-regions': {
        name: 'مناطق الكويت',
        image: 'kuwait-map.gif',
        questions: {
            200: { question: 'ما هي عاصمة الكويت؟', answer: 'الكويت' },
            300: { question: 'في أي محافظة تقع منطقة السالمية؟', answer: 'حولي' },
            500: { question: 'ما هو اسم الجزيرة الكويتية الشهيرة؟', answer: 'فيلكا' },
            800: { question: 'كم عدد المحافظات في دولة الكويت؟', answer: '6' }
        }
    },
    'kuwaiti-restaurants': {
        name: 'مطاعم الكويت',
    ...
    'history': {
        ...
        image: 'history.jpg',
        questions: {
            200: { question: 'في أي عام تأسست دولة الكويت؟', answer: '1613' },
            300: { question: 'من هو أول أمير للكويت؟', answer: 'صباح الأول' },
            500: { question: 'متى حدثت الحرب العالمية الثانية؟', answer: '1939' },
            800: { question: 'ما هو اسم أقدم حضارة في التاريخ؟', answer: 'السومرية' }
        }
    },
    'sports': {
        name: 'الرياضة',
    ...
    'culture': {
        ...
        image: 'culture.jpg',
        questions: {
            200: { question: 'من هو مؤلف رواية "مئة عام من العزلة"؟', answer: 'غابرييل غارسيا ماركيز' },
            300: { question: 'ما هو أشهر متحف في العالم؟', answer: 'اللوفر' },
            500: { question: 'من هو الرسام الذي رسم لوحة "الموناليزا"؟', answer: 'ليوناردو دافنشي' },
            800: { question: 'ما هو أقدم مسرح في العالم؟', answer: 'مسرح ديونيسوس' }
        }
    },
    'science': {
        name: 'العلوم',
    ...
    'technology': {
        ...
        questions: {
            200: { question: 'ما معنى "AI" في التكنولوجيا؟', answer: 'الذكاء الاصطناعي' },
            300: { question: 'من هو مؤسس شركة أبل؟', answer: 'ستيف جوبز' },
            500: { question: 'متى تم اختراع الإنترنت؟', answer: '1983' },
            800: { question: 'ما هو أسرع كمبيوتر في العالم؟', answer: 'فوجاكو' }
        }
    },
    'food': {
        name: 'الطعام',
        image: 'food.jpg',
        questions: {
            200: { question: 'ما هو المكون الرئيسي في الخبز؟', answer: 'الدقيق' },
            300: { question: 'من أي بلد يأتي طبق السوشي؟', answer: 'اليابان' },
            500: { question: 'ما هو أغلى نوع من التوابل؟', answer: 'الزعفران' },
            800: { question: 'كم عدد أنواع الأرز في العالم تقريباً؟', answer: 'أكثر من 40,000' }
        }
    },
    'movies': {
        name: 'الأفلام',
        image: 'movies.jpg',
        questions: {
            200: { question: 'من هو مخرج فيلم "تايتانيك"؟', answer: 'جيمس كاميرون' },
            300: { question: 'في أي عام صدر فيلم "الأسد الملك"؟', answer: '1994' },
            500: { question: 'من فاز بأوسكار أفضل فيلم عام 2020؟', answer: 'طفيلي' },
            800: { question: 'ما هو أطول فيلم في تاريخ السينما؟', answer: 'لوحة فنية' }
        }
    }
};
